...
def remap_word_plane_13_ugly_low_surrogates(x: int) -> int:
    # When we were using Plane 13
    ...
    if x < 0xD800:
        ...
        # Planes 14 15 16 and Low Surrogates all together shift down
        return x + 0x1FC0
    else:
        # Post surrogate
        return x - 0x0800

def remap_word_plane_13(x: int) -> int:
    # When we were using Plane 13
    ...
    if x < 0xD800:
        ...
        # High surrogates: planes 1 to 12
        return x + 0x2000
    elif x < 0xDB40:
        # High surrogates: plane 13
        return x + 0x20C0
    elif x < 0xDC00:
        # High surrogates: planes 14 15 16
        return x + 0x1FC0
    elif x < 0xE000:
        # Low surrogates
        return x + 0x2000
